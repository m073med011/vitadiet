  ...
  <footer class="footer-shell footer-vitadiet">
    <div class="content-wrap relative z-10">
      <div class="footer-grid-vitadiet">
        <div class="space-y-6">
          <NuxtLink :to="localePath('/')" class="vitadiet-brand footer-brand inline-block">
            <BaseImage :src="logoImage" alt="Vitadiet Logo" loading="lazy" class="h-48 sm:h-64 w-auto object-contain invert dark:invert-0 drop-shadow-2xl" />
          </NuxtLink>
        ...
        <div>
          ...
          <div class="space-y-5">
            <div class="footer-contact-row group">
      ...
      <div class="pt-card border-t border-line dark:border-dark-line text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-4">
